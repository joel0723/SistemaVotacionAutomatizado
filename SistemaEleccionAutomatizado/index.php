...
require_once 'folders\AdministrationPages\PuestoElectivo\servicios\PuestosHandler.php';
require_once 'folders\AdministrationPages\Elecciones\servicios\EleccionesHandler.php';
require_once 'folders\objects\Puestos.php';
require_once 'folders\objects\Ciudadanos.php';
...
<div class="row">
    ...
    <?php if ($puestos == "" || $puestos == null) : ?>
        <div class="col-md-4">
     <?php   echo '<script>alert("Ya votaste");</script>';?>
