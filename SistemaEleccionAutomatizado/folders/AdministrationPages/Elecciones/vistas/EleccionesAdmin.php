...
<div class="row">
    ...
    <?php if (isset($_SESSION['elecciones'])) : ?>
        <div class="col-md-2"><a class="btn btn-success" href="../servicios/terminarElecciones.php">Terminar elecciones.</a></div>
    <?php elseif ($validacion == true) : ?>
        <div class="col-md-2"><a class="btn btn-success" href="iniciarElecciones.php">Iniciar elecciones.</a></div>
    <?php elseif ($validacion == false) : ?>
        <div class="col-md-2 bg-danger">
            <h5 class="card-title text-white">Advertencia</h5>
            <p class="card-text text-white">Debe tener al menos tres candidatos, tres partidos y un puesto activo para iniciar una elección.</p>
        </div>
