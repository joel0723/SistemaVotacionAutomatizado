...
<div class="row">
    ...
    <div class="col-md-2"><a class="btn btn-success" href="agregarPartido.php">Agregar partido</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="modificarPartido.php?id_partido=<?= $post->id_partido; ?>" class="btn btn-warning">Modificar</a>
                        
                        <hr>
                        <?php if ($post->estado == 1) : ?>
                            <a href="../servicios/desactivarPartido.php?id_partido=<?= $post->id_partido; ?>" class="btn btn-danger">Desactivar</a>
                        <?php else : ?>
                            <a href="../servicios/activarPartido.php?id_partido=<?= $post->id_partido; ?>" class="btn btn-success">Activar</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
